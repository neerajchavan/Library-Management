...
import library.DAO.FetchStudentDAO;
...
public class IssueBook extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == b1) {
			book.setBookId(Integer.parseInt(t1.getText()));
			book = BookDAO.getBook(book);

			t2.setText(book.getBookName());
			t3.setText(book.getBookIsbn());
			t4.setText(book.getBookPublisher());
			t5.setText(book.getBookEdition());
			t6.setText(Integer.toString(book.getBookPrice()));
			t7.setText(Integer.toString(book.getBookPages()));

		}
		
		if (ae.getSource() == b2) {
			student.setsID(Integer.parseInt(t8.getText()));

			student = FetchStudentDAO.getStudent(student);

			t9.setText(student.getsName());
			t10.setText(student.getsFather());
			t11.setText(student.getsCourse());
			t12.setText(student.getsBranch());
			t13.setText(student.getsYear());
			t14.setText(student.getsSemester());
		...
		if (ae.getSource() == b3) {
			...
			int i = IssueBookDAO.insertIssuedBook(book, student, issueDate);

...
//	}
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource() == b1) {
			...
			book.setBookName(t2.getText());
			book.setBookIsbn(t3.getText());
			book.setBookPublisher(t4.getText());
			book.setBookEdition((String) comboBox.getSelectedItem());
			book.setBookPrice(Integer.parseInt(t5.getText()));
			book.setBookPages(Integer.parseInt(t6.getText()));

			int i = AddBookDAO.addBook(book);

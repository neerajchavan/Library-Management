...
public class AddStudent extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        student.setsID(Integer.parseInt(t1.getText()));
        student.setsName(t2.getText());
        student.setsFather(t3.getText());
        student.setsCourse((String) comboBox_3.getSelectedItem());
        student.setsBranch((String) comboBox.getSelectedItem());
        student.setsYear((String) comboBox_1.getSelectedItem());
        student.setsSemester((String) comboBox_2.getSelectedItem());
        
        int i = AddStudentDAO.addStudent(student);
